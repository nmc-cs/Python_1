...
for i in range(len(gradebook[0])):
    total_score = 0
    # clauclates the total score for each assignment
    for j in range(len(gradebook)):
        total_score += gradebook[j][i]
    # calculates the average score for each assignemnt and prints it
    average = total_score / len(gradebook)
...
for i in range(len(gradebook)):
    #calculates the total score fore each student
    total_score = 0
    for j in range(len(gradebook[0])):
        total_score += gradebook[i][j]
    #caluclates the average score for each student and prints it
    average = total_score / len(gradebook[0])
